...
<div class="w3-top">
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
	...
	<input type="hidden" name="id" value="<%=r.getId()%>">
				<input type="text" name="name" pattern="[A-Za-z0-9 ]*" minlength="3" maxlength="80" required value="<%=r.getName()%>"></td>
				<p></p>
				<input type="radio" name="status" value="true" checked>True
				<input type="radio" name="status" value="false">False</td>
				<p></p>
				<td><input type="submit" value="Guardar Cambios" id="btsubmit"></form>
