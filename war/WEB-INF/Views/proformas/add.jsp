...
<body>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
	...
	<% if(existe){ %>
	<p>Nombre de la proforma ya existe </p>
	<% } %>
	<p></p>
	<div>
	<form method="post" action="/proformas/add" onsubmit="return checkSubmit();">
		...
		<table>
			...
			<tr>
				...
				<td><input id="name" type="input" name="name" pattern="[A-Za-z0-9 ]*" minlength="3" maxlength="80" required></td>
			</tr>
			<tr>
				<td style="color: blue;">Direccion:</td>
				<td><input type="input" name="direccion"  pattern="[A-Za-z0-9. ]*" minlength="3" maxlength="80" required></td>
			</tr>
			<tr>
				<td style="color: blue;">Teléfono:</td>
				<td><input type="number" name="telefono" min="100000" max="1000000000" ></td>
			</tr>
			<tr>
				<td style="color: blue;">Cantidad de productos:</td>
				<td><input type="number" name="cantidad" min="1" max="50" required></td>
			</tr>
